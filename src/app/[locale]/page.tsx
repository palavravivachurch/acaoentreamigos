      ...
      <AppBar position="static" color="transparent" elevation={0} id="appbar">
        <Toolbar sx={{ display: "flex", justifyContent: "space-between" }}>
          <Box display="flex" alignItems="center" gap={2}>
            ...
            <Image
              src="/logos/logoacaoentreamigos.png"
      ...
      >
        ...
        >
          ...
          >
            ...
            <Box maxWidth={600}>
              ...
              <Typography variant="body1">{t("aboutDescription")}</Typography>
            </Box>
          </Box>
        </motion.div>
        ...
        <Box mt={6} textAlign="center">
          <Typography variant="caption">
            ...
            <a href="https://gbl.dev.br">Gabriel Saldanha</a> – Projeto ELO ©{" "}
            {year || ""}
          </Typography>
        </Box>
      </Container>
